...
arch_file = './fusion/arch/3_level_mem_1024KB.json'
...
def do_scheduling_wofusion():
    ...
    for net in all_networks():
        ...
        # optimal schedule
        sg = ScheduleGenerator(network, resource, cost_model, loop_lower_bound, wofusion=True, womincost=True)
        schedule_info_list, _ = sg.schedule_search()
        print("done!\n\n")
        res_parse(schedule_info_list, resource,
                  cost_model, sg, network,
